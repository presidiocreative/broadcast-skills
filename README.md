...
Skills trigger automatically from natural requests ("add pre-order to this product", "set up siblings for the Antigravity colours"), or explicitly with `/broadcast-preorder` and `/broadcast-siblings`.
