...
- `broadcast-siblings`: metafield definitions, one-product-per-colour setup, grouping collection, Siblings block dynamic-source wiring, image swatches, verification script.
